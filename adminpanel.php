  ...
  <body>
      ...
      <div class="container-fluid">
        <a href="adminchart.php">
          ...
          <div class="collapse navbar-collapse text-center" id="mynavbar">
            <ul class="navbar-nav">
              <li class="nav-item search-item text-start ms-3 me-3 mt-1">
               <input type="text" id="search" class="form-control" placeholder="Search..." autofocus="off"> 
               <div class="my-list" id="search-result">
                 <!--Search Results here!-->
               </div>
             </li>
              <li class="nav-item">
   ...
   <form class="d-flex">
    <a class="btn btn-secondary mb-2" id="logout" href="logout.php"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
  </form>
